...
import os
import pickle
from train_utils import train_film
...
def main():
    ...
    # save results
    results_path = os.path.join( 'results', 'film', f'{source_name}.csv' )
    os.makedirs('results', exist_ok=True)
    os.makedirs('results/film', exist_ok=True)

    os.makedirs('saved_models/', exist_ok=True)
    os.makedirs('saved_models/film/', exist_ok=True)
    save_dir = 'saved_models/film/'
